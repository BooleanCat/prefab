...
describe('delete', function()
	it('suceeds', function()
		local state = utils.execute './target/release/prefab delete foo'
	...
	when('invoked incorrectly', function()
		...
		before_each(function()
			state = utils.execute './target/release/prefab delete'
		end)
	...
	when('invoked with -h', function()
		...
		before_each(function()
			state = utils.execute './target/release/prefab delete -h'
		end)
